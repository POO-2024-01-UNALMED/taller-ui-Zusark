	...
	public void handle(ActionEvent event) {
		...
		switch (value) {
			...
			case "/":
				...
				break;
			case "=":
				if (!this.number1.isEmpty() && !this.number2.isEmpty() && !this.operator.isEmpty()) {
					double result = calculate(Double.parseDouble(this.number1), Double.parseDouble(this.number2), this.operator);
					this.displayText.setText(String.valueOf(result));
					this.number1 = "";
					this.number2 = "";
					this.operator = "";
				}
			...
			default:
				...
				this.displayText.setText(this.number1 + this.operator + this.number2);
				break;
		}
	}
